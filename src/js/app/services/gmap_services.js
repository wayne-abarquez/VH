(function () {
    ...
    function gmapServices($log, $q, BASE_URL) {
        ...
        service.defaultLatLng = new google.maps.LatLng(37.662081, 138.142090);
        ...
        service.initializePlacesService = initializePlacesService;
        service.addMarkerInfoWindowClickListener = addMarkerInfoWindowClickListener;
        ...
        function createMap(mapId) {
            ...
            //service.addMapListener('bounds_changed', function(){
            //   console.log('Map Bounds: ', service.map.getBounds().toJSON());
            //});
        ...
        function initializePlacesService () {
            if( !service.placesService) {
                service.placesService = new google.maps.places.PlacesService(service.map);
            }
            return service.placesService;
        }

        var markerInfowindow = null;
        function addMarkerInfoWindowClickListener(marker, infowindowContent) {
            service.addListener(marker, 'click', function(){
                if(markerInfowindow) {
                ...
                markerInfowindow.open(service.map, marker);
            });
        }
